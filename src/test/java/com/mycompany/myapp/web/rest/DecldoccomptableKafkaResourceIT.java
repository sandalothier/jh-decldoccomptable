...
class DecldoccomptableKafkaResourceIT {
    ...
    void setup() {
        ...
        DecldoccomptableKafkaResource kafkaResource = new DecldoccomptableKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/decldoccomptable-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/decldoccomptable-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
